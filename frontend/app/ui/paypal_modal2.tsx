            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75">
                    <div className="relative bg-white p-6 rounded shadow-lg w-3/4 max-w-2xl">
                        ...
                        <p className="text-sm text-gray-500">By clicking the button below you will be redirected to Paypal where you will make the payment in the amount of <strong>{props.amount}$</strong>.</p>
                        <div className="mt-5">
                            <input
                                type="checkbox"
                                id="gdprCheckbox"
                            ...
                            <label htmlFor="gdprCheckbox" className="text-sm text-gray-500">
                                I agree to the <a href="/gdpr" target="_blank" className="text-blue-600 underline">GDPR terms and conditions</a>.
                            </label>
                        </div>
                        <div className="mt-5">
